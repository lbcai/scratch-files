...
def validate(array, i, j):
    if array[i][j] == 0:
        return True
    elif array[i][j] == 1: # /
        if array[i + 1][j - 1] == 1 or array[i - 1][j + 1] == 1:
            return False
        elif array[i + 0][j - 1] == 2 or array[i + 0][j + 1] == 2 or array[i + 1][j + 0] == 2 or array[i - 1][j + 0] == 2:
            return False
        else:
            return True
    elif array [i][j] == 2: # \
        if array[i - 1][j - 1] == 2 or array[i + 1][j + 1] == 2:
            return False
        elif array[i + 0][j - 1] == 1 or array[i + 0][j + 1] == 1 or array[i + 1][j + 0] == 1 or array[i - 1][j + 0] == 1:
            return False
        else:
            return True
    else:
